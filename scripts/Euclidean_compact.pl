...
############################################################################
 ...
 my($IN,$OUT,$line,$name,$path_out,$path_target,$target,$file,$path_pdb,$return_val,$len,$ideal_radius,$pair_wise_distance,$quality,$words);
 ...
 $| = 1;
  ...
  $target= (split '\/', $path_target)[-1];
		 $path_pdb=$path_target;
